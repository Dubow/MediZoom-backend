...
router.post("/book", authenticateToken, async (req, res) => {
    ...
    try {
        ...
        // Check if an existing appointment with "Pending Payment" status exists
        ...
        if (existingAppointment.length > 0) {
            // Update the existing appointment's created_at to reset the 15-minute timer
            ...
            // Check for conflicts (already booked by another client)
            ...
            // Insert new appointment with "Pending Payment" status
